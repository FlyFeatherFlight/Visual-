...
namespace ChicST_MM.WEB.App_Start
{
    public class AutoFacConfig
    {
        ...
        public static void Register()
        {
            ...
            Assembly controllerAss = Assembly.Load("ChicST-MM.WEB");
            builder.RegisterControllers(controllerAss);
            //builder.RegisterModelBinders(controllerAss);

            //如果有Dal层的话，注册Dal层的组件
            //告诉autofac框架注册数据仓储层所在程序集中的所有类的对象实例
            Assembly dalAss = Assembly.Load("ChicST-MM.DAL");
            ...
            Assembly serviceAss = Assembly.Load("ChicST-MM.BLL");
