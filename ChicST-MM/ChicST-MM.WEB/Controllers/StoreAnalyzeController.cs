...
namespace ChicST_MM.WEB.Controllers
{
    ...
    public class StoreAnalyzeController : Controller
    {
        ...
        public StoreAnalyzeController(IStoreEmployeesBLL storeEmployeesBLL, IStoreBLL storeBLL, ITrackGoalBLL trackGoalBLL, ICustomerInfoBLL customerInfoBLL, ICustomerTrackingBLL customerTrackingBLL)
        {
